...
static bool hyp_check_page_ro(u64 va)
{
	...
	fastuh_call(FASTUH_APP_KDP, TEST_GET_PAR, (unsigned long)va, KDP_PA_WRITE, 0, 0);
	par = *ha1;
...
static int __init kdp_test_init(void)
{
	...
	fastuh_call(FASTUH_APP_KDP, TEST_GET_RO, va, 0, 0, 1);
...
{
	fastuh_call(FASTUH_APP_KDP, TEST_GET_RO, (u64)ha1, 0, 0, 0);
