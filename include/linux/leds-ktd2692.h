...
#define KTD2692_FACTORY_DEFAULT_CURRENT 240	/* 240mA */
#define KTD2692_TORCH_DEFAULT_CURRENT	240	/* 240mA */
...
struct ktd2692_platform_data {
	...
	enum ktd2692_video_current_t factory_current_value;
	enum ktd2692_video_current_t torch_current_value;
