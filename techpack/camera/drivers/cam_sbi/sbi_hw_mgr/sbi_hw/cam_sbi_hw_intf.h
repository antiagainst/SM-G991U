...
enum cam_sbi_hw_cmd_type {
	...
	CAM_SBI_HW_CMD_WRITEREG_TASK2_ERROR_ACTION,
	CAM_SBI_HW_CMD_UPDATE_SSM_INFO,
	CAM_SBI_HW_CMD_ENABLE_VVALID_TIME_LOG,
};
...
enum cam_sbi_hw_reset_type {
	CAM_SBI_HW_RESET_TYPE_SBI0_RESET,
	CAM_SBI_HW_RESET_TYPE_SBI1_RESET,
	CAM_SBI_HW_RESET_TYPE_SBI2_RESET,
};
