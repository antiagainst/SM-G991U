...
enum shooting_mode_t {
    CAM_SHOOTING_MODE_SINGLE,
    CAM_SHOOTING_MODE_AUTO,
    CAM_SHOOTING_MODE_BEAUTY,
    CAM_SHOOTING_MODE_VIDEO,
    CAM_SHOOTING_MODE_PANORAMA,
    CAM_SHOOTING_MODE_PRO,
    CAM_SHOOTING_MODE_SELECTIVE_FOCUS,
    CAM_SHOOTING_MODE_HDR,
    CAM_SHOOTING_MODE_NIGHT,
    CAM_SHOOTING_MODE_FOOD,
    CAM_SHOOTING_MODE_DUAL_PIP,
    CAM_SHOOTING_MODE_ANTI_FOG,
    CAM_SHOOTING_MODE_WIDE_SELFIE,
    CAM_SHOOTING_MODE_SLOW_MOTION,
    CAM_SHOOTING_MODE_INTERACTIVE,
    CAM_SHOOTING_MODE_SPORTS,
    CAM_SHOOTING_MODE_HYPER_MOTION,
    CAM_SHOOTING_MODE_ANIMATED_GIF,
    CAM_SHOOTING_MODE_COLOR_IRIS,
    CAM_SHOOTING_MODE_AQUA_SCENE,
    CAM_SHOOTING_MODE_SUPER_SLOW_MOTION,
    CAM_SHOOTING_MODE_LIVE_FOCUS,
    CAM_SHOOTING_MODE_FACE_LOCK,
    CAM_SHOOTING_MODE_MULTI_BIOMETRIC,
    CAM_SHOOTING_MODE_STICKER,
    CAM_SHOOTING_MODE_SELFIE_FOCUS,
    CAM_SHOOTING_MODE_LABS,
    CAM_SHOOTING_MODE_REAR_SELFIE,
    CAM_SHOOTING_MODE_BOKEH_VIDEO,
    CAM_SHOOTING_MODE_INSTAGRAM_VIDEO,
    CAM_SHOOTING_MODE_ILLUMINANCE,
    CAM_SHOOTING_MODE_SUPER_NIGHT,
    CAM_SHOOTING_MODE_DIRECTORS_VIEW_SINGLE,
    CAM_SHOOTING_MODE_SINGLE_TAKE_PHOTO,
    CAM_SHOOTING_MODE_SINGLE_TAKE_PHOTO_FRONT,
    CAM_SHOOTING_MODE_PRO_VIDEO,
    CAM_SHOOTING_MODE_QUICK_TAKE_VIDEO,
    CAM_SHOOTING_MODE_DIRECTORS_VIEW_MULTI,
    CAM_SHOOTING_MODE_MAX
};
