...
static int __init veml3328_sub_light_factory_init(void)
{
...
static void __exit veml3328_sub_light_factory_exit(void)
{
	adsp_factory_unregister(MSG_LIGHT_SUB);

	pr_info("[FACTORY] %s\n", __func__);
}
module_init(veml3328_sub_light_factory_init);
module_exit(veml3328_sub_light_factory_exit);
